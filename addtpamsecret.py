...
usage_definition = f'''
    ...
    python addtpamsecret.py --secretmanagername 'SecretManager name' --secret_names "first, second, third" --secret_values "value1, value2, value3"
    or using the shortcuts for the arguments' names
    python addtpamsecret.py -m 'SecretManager name ' -n "first, second, third" -v "value1, value2, value3"
    
    Example:
        python addtpamsecret.py -m "TPAM" -n "Amazon password, Google cloud password, Azure credentials" -v "AmaZonPwd, GCpWd, aZurEpWd"
